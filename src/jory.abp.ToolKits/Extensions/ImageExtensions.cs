...
namespace jory.abp.ToolKits.Extensions
{
    public static class ImageExtensions
    {
        ...
        //    var watermarkImg = MediaTypeNames.Image.Load(watermarkBytes);
        //    var img = MediaTypeNames.Image.Load(imgBytes, out IImageFormat format);
